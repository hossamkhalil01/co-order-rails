...
ActiveRecord::Schema.define(version: 2021_03_27_182547) do
  ...
  create_table "details", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["orderer_id"], name: "index_details_on_orderer_id"
  end
  ...
  create_table "users", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.string "image", default: "https://i.ibb.co/SK3QN1j/unknown-image.jpg", null: false
  ...
  add_foreign_key "details", "users", column: "orderer_id"
  add_foreign_key "friendships", "users"
  add_foreign_key "friendships", "users", column: "friend_id"
  add_foreign_key "groups", "users", column: "owner_id"
  add_foreign_key "invitations", "orders"
  add_foreign_key "invitations", "users", column: "participant_id"
